...
import com.petassegang.addons.backrooms.level.level0.generation.stage.biome.LevelZeroSurfaceBiomeStage;
...
import com.petassegang.addons.backrooms.level.level0.generation.stage.region.LevelZeroSectorCacheKeyStage;
import com.petassegang.addons.backrooms.level.level0.generation.stage.topology.LevelZeroLargeRoomStage;
...
public final class LevelZeroLegacyLayoutPipeline {
    ...
    public LevelZeroCellEvaluation evaluateCell(LevelZeroCellContext context,
        ...
        int connectionMask = walkable && !largeRoom
                ...
                : com.petassegang.addons.backrooms.level.level0.generation.layout.LevelZeroCellConnections.none();
        ...
        int geometryMask = lighted
                ? com.petassegang.addons.backrooms.level.level0.generation.layout.LevelZeroGeometryMask.none()
        ...
        int microPattern = topology == LevelZeroCellTopology.WALL
                ...
                : geometryMask == com.petassegang.addons.backrooms.level.level0.generation.layout.LevelZeroGeometryMask.none()
