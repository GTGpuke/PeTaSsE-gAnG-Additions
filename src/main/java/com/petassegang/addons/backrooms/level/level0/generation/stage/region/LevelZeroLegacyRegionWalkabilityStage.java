...
public final class LevelZeroLegacyRegionWalkabilityStage implements LevelZeroRegionStage<LevelZeroRegionWalkability> {
    ...
    public LevelZeroRegionWalkability sample(LevelZeroRegionContext context) {
        ...
        com.petassegang.addons.backrooms.level.level0.generation.layout.sector.LevelZeroSectorRoomKind[] roomKinds =
                new com.petassegang.addons.backrooms.level.level0.generation.layout.sector.LevelZeroSectorRoomKind[width * height];
